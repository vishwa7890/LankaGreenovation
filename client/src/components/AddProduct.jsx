...
const AddProduct = () => {
  ...
  const handleInputChange = (e) => {
    ...
    setProduct((prev) => ({
      ...prev,
      [name]:
        name === "availablestock" || name === "numberOfItems"
          ? Number(value)
          : value,
    }));
  };
  ...
  const validate = () => {
    ...
    if (
      ...
      newErrors.availablestock = "Stock must be zero or more.";
    ...
    // Add other required fields validations here if needed
  ...
  const fields = [
    ...
    { label: "Detailed Description", name: "detailedDescription", textarea: true },
    {
      ...
      name: "category",
      select: true,
      options: ["Food Product", "Cosmetics", "Biofertilizers"],
    },
